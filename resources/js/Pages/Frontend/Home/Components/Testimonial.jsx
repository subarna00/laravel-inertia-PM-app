                            ...
                            >
                                <div className="item">
                                    <div className="video-image">
                                        <img
                                            ...
                                            src="images/feature-info/01.jpg"
                                            alt=""
                                        />
                                        <a
                                        ...
                                        >
                                            ...
                                            <div className="svg-item">
                                                <svg
                                                    ...
                                                    height="48px"
                                                    viewBox="0 0 1920 48"
                                                    // style="enable-background:new 0 0 1920 48;"
                                                    xml:space="preserve"
                                                >
                                                    <polygon
                                                        id="XMLID_1_"
                                    ...
                                    <div className="testimonial-item">
                                        ...
                                        <div className="testimonial-content">
                                            <p>
                                                ...
                                                seriously, but seriously enough
                                                to ensure we're creating the
                                                best product and experience for
                                                our customers. I feel like Help
                                                Scout does the same.
                                            </p>
                                        </div>
                                ...
                                <div className="item">
                                    <div className="video-image">
                                        <img
                                            className="img-fluid w-100"
                                            src="images/feature-info/02.jpg"
                                            alt=""
                                        />
                                        <a
                                            className="popup-icon popup-youtube"
                                    ...
                                    <div className="testimonial-item">
                                        ...
                                        <div className="testimonial-content">
                                            <p>
                                                Hi-Soft is the next killer app.
                                                Hi-Soft did exactly what you
                                                said it does. I will let my mum
                                                know about this, she could
                                                really make use of hi-soft!
                                                Thank you for making it
                                                painless, pleasant and most of
                                                all hassle free!
                                            </p>
                                        </div>
                                        <div className="testimonial-author">
                                ...
                                <div className="item">
                                    <div className="video-image">
                                        <img
                                            className="img-fluid w-100"
                                            src="images/feature-info/03.jpg"
                                            alt=""
                                        />
                                        <a
                                            className="popup-icon popup-youtube"
                        ...
                        <div className="col-lg-6 col-xl-5 align-self-center ps-0 ps-lg-5 mt-5 mt-lg-0">
                            <div className="ps-3 ps-lg-4">
                                <h2 className="mb-4 mb-lg-5">
                                    Over 500 clients and 5,000 projects across
                                    the globe.
                                </h2>
                                <a
                                    href="#"
