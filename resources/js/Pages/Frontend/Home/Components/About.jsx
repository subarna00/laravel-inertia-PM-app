                                ...
                                >
                                    <div className="row">
                                        ...
                                        <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                                            <h4>
                                                <i className="flaticon-target text-primary me-2"></i>{" "}
                                                Our Mission
                                            </h4>
                                            <p className="mb-4">
                                                Our mission is to be the
                                                industry's premier service
                                                provider company concentrated on
                                                fulfilling the maximum to our
                                                clients.{" "}
                                            </p>
                                            <h4>
                                                <i className="flaticon-eye text-primary me-2"></i>{" "}
                                                Our Vision
                                            </h4>
                                            <p className="mb-4">
                                                Our Vision is to be a top Web
                                                Design company in the IT sector
                                                and progress in our current
                                                position in the market.{" "}
                                            </p>
                                            <h6 className="fw-normal text-muted mt-4">
                                                Our Vision and Mission are both
                                                encouraging our team to
                                                accomplish the goal. We
                                                recognize the clients'
                                                requirements, analyze them, and
                                                provide the best solutions. We
                                                satisfy our clients by our
                                                services and implements it with
                                                more capable software solution
                                                approaches.
                                            </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                                            <h4 className="mb-4 text-dark">
                                                ...
                                                clients deliver marvelous
                                                results when it comes to their
                                                projects. From data to
                                                performance, we’ve got you
                                                covered.”
                                            </h4>
                                            ...
                                            <p className="mb-4">
                                                We know this in our gut, but
                                                what can we do about it? How can
                                                we motivate ourselves? One of
                                                the most difficult aspects of
                                                achieving success is staying
                                ...
                                >
                                    <div className="row">
                                        ...
                                        <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                                            ...
                                            <p>
                                                We partnered with Technology
                                                Managers to increase its skills
                                                at every step of the software
                                                development process.
                                            </p>
                                            <div className="row">
                                        ...
                                        <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                                            <div className="row">
                                                <div className="col-12 mb-4">
                                                    ...
                                                    <p>
                                                        Meet our leaders and the
                                                        hard-working
                                                        personalities who
                                                        deliver innovative
                                                        concepts to corporations
                                                        like yours.
                                                    </p>
                                                </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-7 align-self-start align-self-lg-center ps-md-0 ps-lg-5">
                                            ...
                                            <p className="mb-4">
                                                ...
                                                excited about the digital world
