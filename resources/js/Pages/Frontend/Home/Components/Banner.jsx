                ...
                <div className="swiper-container">
                    <div className="swiper-wrapper h-700 h-sm-500">
                        <div
                            ...
                            // style="background-image:url(images/slider/01.jpg); background-size: cover; background-position: center center;"
                        >
                                ...
                                <div className="row justify-content-center">
                                    <div className="col-lg-9 col-md-10 text-center position-relative">
                                        <h1
                                            ...
                                            data-delay="0.25s"
                                        >
                                            A digital marketing company you can
                                            trust
                                        </h1>
                                        <h6
                                            data-swiper-animation="fadeInUp"
                        ...
                        <div
                            className="swiper-slide align-items-center d-flex responsive-overlap-md bg-overlay-black-30"
                            // style="background-image:url(images/slider/02.jpg); background-size: cover; background-position: center center;"
                        >
                            <div className="swipeinner container">
                                <div className="row justify-content-center">
                                    <div className="col-lg-9 col-md-11 text-center position-relative">
                                        ...
                                        <h6
                                            ...
                                            data-delay="0.5s"
                                        >
                                            We're Hi-soft. We help drive change
                                            with technology.
                                        </h6>
                                        <a
                                            className="btn btn-dark btn-round text-white"
                    ...
                    <div className="swiper-button-next">
                        <i className="fas fa-arrow-right icon-btn"></i>
                    </div>
                </div>
            </section>
        </>
