                    ...
                    <div className="row align-items-center pb-4 pb-md-5">
                        <div className="col-lg-6">
                            <h2 className="text-white mb-2 mb-lg-0">
                                We excel in our industry so that you can get in
                                yours.
                            </h2>
                        </div>
                        <div className="col-lg-6">
                            <p className="lead text-white mb-0">
                                ...
                                See some of the industries we have vast
                                experience working in as a full-service
                                marketing agency.
                            </p>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-lg-3 mt-4 mt-lg-0">
                            <ul className="category-list">
                                ...
                                <li>
                                    <a href="#">Logistics and Distribution</a>
                                </li>
                                <li>
                                    <a href="#">Utilities</a>
                                </li>
                    ...
                    <div className="row mt-4 mt-md-5">
                        <div className="col-12 d-md-flex justify-content-center align-items-center">
                            <p className="mb-3 mb-md-0 mx-0 mx-md-3 text-white">
                                We provide solutions for all types of big
                                industries
                            </p>
                            <a
                                href="#"
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="section-title is-sticky">
                                ...
                                <p className="mb-4">
                                    Please take a look at the range of{" "}
                                    <b>IT solution</b> services we offer to your
                                    brand as a full-service leading marketing
                                    agency.
                                </p>
                                <a
                                    href="#"
                                ...
                                <div className="col-sm-6">
                                    <div className="feature-info feature-info-style-01">
                                        ...
                                        <div className="feature-info-content">
                                            ...
                                            <p className="mb-0">
                                                Do it today. Remind yourself of
                                                someone you know who died
                                                suddenly and the fact that there
                                                is no guarantee that tomorrow
                                                will come.
                                            </p>
                                            <a
                                    ...
                                    <div className="feature-info feature-info-style-01 mt-4 mt-lg-5">
                                        ...
                                        <div className="feature-info-content">
                                            ...
                                            <p className="mb-0">
                                                ...
                                                and it’s not reserved only for a
                                                select few people. As such,
                                                success really has nothing to do
                                                with luck,
                                            </p>
                                            <a
                                                href="service-detail.html"
                                ...
                                <div className="col-sm-6">
                                    <div className="feature-info feature-info-style-01 mt-4 mt-lg-5">
                                        ...
                                        <div className="feature-info-content">
                                            ...
                                            <p className="mb-0">
                                                Positive pleasure-oriented goals
                                                are much more powerful
                                                motivators than negative
                                                fear-based ones. Although each
                                                is successful separately.
                                            </p>
                                            <a
                                                href="service-detail.html"
                                                className="icon-btn"
                                    ...
                                    <div className="feature-info feature-info-style-01 mt-4 mt-lg-5">
                                        ...
                                        <div className="feature-info-content">
                                            ...
                                            <p className="mb-0">
                                                It must come from within as the
                                                natural product of your desire
                                                to achieve something and your
                                                belief that you are capable to
                                    ...
                                    <div className="feature-info feature-info-style-01 mt-4 mt-lg-5">
                                        ...
                                        <div className="feature-info-content">
                                            ...
                                            <p className="mb-0">
                                                There are basically six key
                                                areas to higher achievement.
                                                Some people will tell you there
                                                are four while others may tell
                                                you there are eight.
                                            </p>
                                            <a
                                                href="service-detail.html"
